package com.cmcc.hsp.client.netty.decoder;

import com.cmcc.hsp.client.netty.model.ConstantValue;
...
public class STBMessageDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        System.out.println("客户端-----------byteBuf.readableBytes():"+byteBuf.readableBytes());
        //可读长度必须大于基本长度
